package com.sping.domain4.constant;
...
import java.util.function.Predicate;@Getter
...
public enum ErrorCode {
    ...
    public static ErrorCode valueOf(HttpStatus httpStatus) throws GeneralException {
