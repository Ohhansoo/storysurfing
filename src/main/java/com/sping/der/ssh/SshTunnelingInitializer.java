...
public class SshTunnelingInitializer {
    ...
    private String host = "43.201.122.223";
    private String user = "admin";
    private int sshPort = 22;
    private String privateKey = "/src/main/resources/SPING_DEV.pem";
    ...
    public Integer buildSshConnection() {
        ...
        try {
            ...
            forwardedPort = session.setPortForwardingL(3306, "43.201.122.223", databasePort);
